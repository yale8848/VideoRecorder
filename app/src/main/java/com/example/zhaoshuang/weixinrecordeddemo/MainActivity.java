...
public class MainActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void syntVideo(){
       ...
       String  cmd = "ffmpeg -y -i " + output + " -strict -2 -vcodec libx264 -preset ultrafast " +
                "-crf 24 -acodec aac -ar 44100 -ac 2 -b:a 96k -s 320x480 -aspect 9:16 " + MyApplication.VIDEO_PATH+"/finish1.mp4";
